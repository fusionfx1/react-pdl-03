...
const data = [
  ...
  },
  {
    ...
    content: `There is no cost to fill out our online loan application form and submit your information through our website. As a loan marketplace, we simply connect you to a prospective lender and receive a commission from successful matches. We do not receive any information that allows us to evaluate or compare offers from potential lenders. Please carefully review any loan offer you receive from a lender to make sure it meets your needs and you fully understand the terms before proceeding to take out a loan.`,
  },
  {
    title: `Can I get a loan with poor credit or bad credit?`,
    content: `
    <div>Qualifying with a short-term lender can be easy and they are used to working with people in many different financial situations. Here are the basic qualifications for loans:</div>
